...
AS $$
DECLARE
  project_url TEXT := 'https://jakntvekbwhpcleqiavg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impha250dmVrYndocGNsZXFpYXZnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTA4MTU4MzksImV4cCI6MjAyNjM5MTgzOX0.jncf6ce3t08dzXtCP5DqEOnJiH0DNu-I_Ava-4cz5cg'; -- full access needed for http request to storage
